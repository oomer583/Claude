...
**Durum:** Devam ediyor. npm workspaces tabanlı monorepo, Next.js web, Fastify API, ortak tip paketi, temel health check ve PostgreSQL içeren Docker Compose topolojisi kurulmuştur. Migration, CI, yedek/restore ve gözlemlenebilirlik çalışmaları tamamlanmamıştır.
