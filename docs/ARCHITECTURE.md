...
Bu belge hedef mimariyi ve temel teknik sınırları tanımlar; henüz uygulanmış bir sistemi tarif etmez. Tasarım, küçük bir ekibin hızlı ilerleyebilmesini sağlarken güvenlik, maliyet kontrolü ve ileride servis ayrıştırma ihtiyacını gözetir.
...
Bu yapı bir yön önerisidir. Başlangıç iskeleti oluşturulurken build sistemi, paket yöneticisi ve workspace kararı kayda alınmalıdır.
...
- Monorepo aracı ve paket yöneticisi
